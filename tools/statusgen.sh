...
| \`c2id\` | $c2_f | $c2_c | $((c2_f * 2)) |
| \`linux_id\` | $lin_f | $lin_c | $((lin_f * 2)) |
| **total** | **$((here_f + std_f + c2_f + lin_f))** | **$have** | **$need** |

**Adoption: $pct%.** Generated by \`idc/tools/statusgen.sh\`; \`idc/tests/run.sh\` fails
